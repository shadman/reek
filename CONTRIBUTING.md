...
Instead, we use the [military alphabet](https://en.wikipedia.org/wiki/NATO_phonetic_alphabet) in descending order
...
TODO: Example below does not get rendered properly. Wtf.
